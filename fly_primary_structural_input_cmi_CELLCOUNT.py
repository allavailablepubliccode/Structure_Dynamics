"""
Drosophila cell-count structural-input conditional mutual information analysis.
...
where W[source, target] is cell-count connectivity (the number of neurons linking each source-target region pair).

This robustness analysis repeats the primary test using cell-count rather than weighted T-bar connectivity. The empirical connectome is compared with a strict surrogate ensemble that
preserves:
...
OUTPUT_FILE = "fly_primary_structural_input_cmi_CELLCOUNT_results.npz"
...
def main() -> None:
    """Run the cell-count strict-null robustness analysis."""
    ...
    print("\n" + "=" * 76)
    print("FINAL STRICT FLY STRUCTURAL-INPUT CMI — CELL COUNT")
    print("=" * 76)
    ...
    print("\n" + "=" * 76)
    print("FINAL STRICT FLY RESULT — CELL COUNT")
    print("=" * 76)
    ...
    np.savez_compressed(
        ...
        structural_metric=np.array("cellcount"),
